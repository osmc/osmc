...
then
pull_source "https://github.com/xbmc/xbmc/archive/5bd45ab776d15e836b881cc4e12fbc5a7abc95a2.tar.gz" "$(pwd)/src"
API_VERSION="17"
else
...
then
	...
	COMMON_DEPENDS="niceprioritypolicy-osmc, mediacenter-send-osmc, libssh-4, libavahi-client3, python, python-imaging, python-unidecode, libsmbclient, libjpeg62-turbo, libsqlite3-0, libtinyxml2.6.2, libmad0, libmicrohttpd10, libyajl2, libmariadbclient18, libasound2, libxml2, liblzo2-2, libxslt1.1, libpng16-0, libsamplerate0, libtag1-vanilla, libfribidi0, libgif4, libcdio13, libpcrecpp0, libfreetype6, libvorbis0a, libvorbisenc2, libcurl3, libssl1.0.2, libplist2, avahi-daemon, policykit-1, mediacenter-addon-osmc (>= 3.0.39), mediacenter-skin-osmc, libcrossguid0"
