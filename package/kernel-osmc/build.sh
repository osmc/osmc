...
test $1 == vero2 && VERSION="3.10.106" && REV="3" && FLAGS_INITRAMFS=$(($INITRAMFS_BUILD)) && IMG_TYPE="uImage"
...
test $1 == vero364 && VERSION="3.14.29" && REV="24" && FLAGS_INITRAMFS=$(($INITRAMFS_BUILD)) && IMG_TYPE="zImage"
