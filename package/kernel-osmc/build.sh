...
test $1 == vero2 && VERSION="3.10.104" && REV="14" && FLAGS_INITRAMFS=$(($INITRAMFS_BUILD)) && IMG_TYPE="uImage"
...
test $1 == vero364 && VERSION="3.14.29" && REV="12" && FLAGS_INITRAMFS=$(($INITRAMFS_BUILD)) && IMG_TYPE="zImage"
