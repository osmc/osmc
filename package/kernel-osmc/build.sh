...
test $1 == vero && VERSION="4.1.3" && REV="2"
...
then
	...
	export ARCH
		...
		if [ "$1" == "atv" ] || [ "$1" == "vero" ]; then mv rtl8192cu-new drivers/net/wireless/rtl8192cu; fi
