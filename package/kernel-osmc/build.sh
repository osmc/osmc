...
test $1 == vero364 && VERSION="4.9.269" && REV="39" && FLAGS_INITRAMFS=$(($INITRAMFS_BUILD)) && IMG_TYPE="zImage" && SIGN_KERNEL=0
test $1 == vero564 && VERSION="4.9.269" && REV="42" && FLAGS_INITRAMFS=$(($INITRAMFS_BUILD)) && IMG_TYPE="zImage" && SIGN_KERNEL=1
if [ $1 == "rbp2" ] || [ $1 == "rbp464" ]
then
