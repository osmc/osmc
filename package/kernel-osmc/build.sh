...
. ../common.sh
test $1 == rbp1 && VERSION="4.9.29" && REV="17" && FLAGS_INITRAMFS=$(($INITRAMFS_BUILD + $INITRAMFS_EMBED)) && IMG_TYPE="zImage"
test $1 == rbp2 && VERSION="4.9.29" && REV="15" && FLAGS_INITRAMFS=$(($INITRAMFS_BUILD + $INITRAMFS_EMBED)) && IMG_TYPE="zImage"
...
test $1 == vero364 && VERSION="3.14.29" && REV="54" && FLAGS_INITRAMFS=$(($INITRAMFS_BUILD)) && IMG_TYPE="zImage"
