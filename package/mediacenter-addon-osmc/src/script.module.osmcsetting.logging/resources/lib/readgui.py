...
DEFAULT_STRINGSFILE = (
    "/usr/share/kodi/addons/resource.language.en_gb/resources/strings.po"
)
            ...
            if self.system_settings[sj]["default"] != setting.text:
                try:
                    setting_formatted += " ===> Default: {}".format(
                        self.system_strings[
                            section["options"][self.system_settings[sj]["default"]]
                        ]
                    )
                except Exception:
