                    ...
                    if module["id"] == "script.module.osmcsetting.networking":
                        ...
                        if vendor == "noobs":
                            ...
                            update_check_now = DIALOG.yesno(
                                lang(32026), lang(32027), lang(32028), lang(32029)
                            )

                        elif vendor == "ts":

                            update_check_now = DIALOG.yesno(
                                lang(32026), lang(32030), lang(32031), lang(32029)
                            )
            ...
            if not self.parent_queue.empty():
                ...
                if response == "open":
                    ...
                    if device_id:
                        ...
                        if (
                            device_id not in ignore_list
                            and device_id not in media_string
                        ):
