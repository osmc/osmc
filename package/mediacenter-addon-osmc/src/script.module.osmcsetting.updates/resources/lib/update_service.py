...
__image_file__ = os.path.join(
    __scriptPath__, "resources", "media", "update_available.png"
)
...
class Main(object):
    ...
    def __init__(self):
        ...
        self.UPDATE_WARNING_LIST = ["-mediacenter-osmc"]

        # Items that start with a hyphen should have the hardware prefix attached
        self.UPDATE_WARNING_LIST = [
            (str(self.hw_prefix) + x) if x[0] == "-" else x
            for x in self.UPDATE_WARNING_LIST
        ]
        ...
        self.listener = comms.communicator(
            self.parent_queue, socket_file="/var/tmp/osmc.settings.update.sockfile"
        )
        self.listener.start()
    ...
    def update_settings(self):
        ...
        if self.first_run:
            ...
            self.s["suppress_progress"] = (
                True if __setting__("suppress_progress") == "true" else False
            )
            self.s["suppress_icon"] = (
                True if __setting__("suppress_icon") == "true" else False
            )
            self.s["update_on_idle"] = (
                True if __setting__("update_on_idle") == "true" else False
            )
            self.s["home_prompts_only"] = (
                True if __setting__("home_prompts_only") == "true" else False
            )
            ...
            self.s["backup_on_update"] = (
                True if __setting__("backup_on_update") == "true" else False
            )
            self.s["backup_addons"] = (
                True if __setting__("backup_addons") == "true" else False
            )
            self.s["backup_addon_data"] = (
                True if __setting__("backup_addon_data") == "true" else False
            )
            self.s["backup_Database"] = (
                True if __setting__("backup_Database") == "true" else False
            )
            self.s["backup_keymaps"] = (
                True if __setting__("backup_keymaps") == "true" else False
            )
            self.s["backup_library"] = (
                True if __setting__("backup_library") == "true" else False
            )
            self.s["backup_playlists"] = (
                True if __setting__("backup_playlists") == "true" else False
            )
            self.s["backup_profilesF"] = (
                True if __setting__("backup_profilesF") == "true" else False
            )
            self.s["backup_Thumbnails"] = (
                True if __setting__("backup_Thumbnails") == "true" else False
            )
            self.s["backup_favourites"] = (
                True if __setting__("backup_favourites") == "true" else False
            )
            self.s["backup_keyboard"] = (
                True if __setting__("backup_keyboard") == "true" else False
            )
            self.s["backup_remote"] = (
                True if __setting__("backup_remote") == "true" else False
            )
            self.s["backup_LCD"] = (
                True if __setting__("backup_LCD") == "true" else False
            )
            self.s["backup_profiles"] = (
                True if __setting__("backup_profiles") == "true" else False
            )
            self.s["backup_RssFeeds"] = (
                True if __setting__("backup_RssFeeds") == "true" else False
            )
            self.s["backup_sources"] = (
                True if __setting__("backup_sources") == "true" else False
            )
            self.s["backup_upnpserver"] = (
                True if __setting__("backup_upnpserver") == "true" else False
            )
            self.s["backup_peripheral_data"] = (
                True if __setting__("backup_peripheral_data") == "true" else False
            )
            self.s["backup_guisettings"] = (
                True if __setting__("backup_guisettings") == "true" else False
            )
            self.s["backup_fstab"] = (
                True if __setting__("backup_fstab") == "true" else False
            )
            self.s["backup_advancedsettings"] = (
                True if __setting__("backup_advancedsettings") == "true" else False
            )
            ...
            tmp_s["suppress_progress"] = (
                True if __setting__("suppress_progress") == "true" else False
            )
            tmp_s["suppress_icon"] = (
                True if __setting__("suppress_icon") == "true" else False
            )
            tmp_s["update_on_idle"] = (
                True if __setting__("update_on_idle") == "true" else False
            )
            tmp_s["home_prompts_only"] = (
                True if __setting__("home_prompts_only") == "true" else False
            )
            tmp_s["suppress_progress"] = (
                True if __setting__("suppress_progress") == "true" else False
            ...
            tmp_s["backup_on_update"] = (
                True if __setting__("backup_on_update") == "true" else False
            )
            tmp_s["backup_addons"] = (
                True if __setting__("backup_addons") == "true" else False
            )
            tmp_s["backup_addon_data"] = (
                True if __setting__("backup_addon_data") == "true" else False
            )
            tmp_s["backup_Database"] = (
                True if __setting__("backup_Database") == "true" else False
            )
            tmp_s["backup_keymaps"] = (
                True if __setting__("backup_keymaps") == "true" else False
            )
            tmp_s["backup_library"] = (
                True if __setting__("backup_library") == "true" else False
            )
            tmp_s["backup_playlists"] = (
                True if __setting__("backup_playlists") == "true" else False
            )
            tmp_s["backup_profilesF"] = (
                True if __setting__("backup_profilesF") == "true" else False
            )
            tmp_s["backup_Thumbnails"] = (
                True if __setting__("backup_Thumbnails") == "true" else False
            )
            tmp_s["backup_favourites"] = (
                True if __setting__("backup_favourites") == "true" else False
            )
            tmp_s["backup_keyboard"] = (
                True if __setting__("backup_keyboard") == "true" else False
            )
            tmp_s["backup_remote"] = (
                True if __setting__("backup_remote") == "true" else False
            ...
            tmp_s["backup_profiles"] = (
                True if __setting__("backup_profiles") == "true" else False
            )
            tmp_s["backup_RssFeeds"] = (
                True if __setting__("backup_RssFeeds") == "true" else False
            )
            tmp_s["backup_sources"] = (
                True if __setting__("backup_sources") == "true" else False
            )
            tmp_s["backup_upnpserver"] = (
                True if __setting__("backup_upnpserver") == "true" else False
            )
            tmp_s["backup_peripheral_data"] = (
                True if __setting__("backup_peripheral_data") == "true" else False
            )
            tmp_s["backup_guisettings"] = (
                True if __setting__("backup_guisettings") == "true" else False
            )
            tmp_s["backup_fstab"] = (
                True if __setting__("backup_fstab") == "true" else False
            )
            tmp_s["backup_advancedsettings"] = (
                True if __setting__("backup_advancedsettings") == "true" else False
            )
    ...
    def apt_error(self, **kwargs):
        ...
        log(
            "apt_updater encountered and error: \nException : %s \nPackage : %s \nError : %s"
            % (
                kwargs.get("exception", "not provided"),
                package,
                kwargs.get("error", "not provided"),
            )
        )
    ...
    def action_list(self, action):
        ...
        root_space, _ = self.check_target_location_for_size(
            location="/", requirement=300
        )
        if root_space:
    ...
    def action_list_complete(self):
        ...
        if any(
            [
                os.path.isfile("/tmp/reboot-needed"),
    ...
    def progress_bar(self, **kwargs):
        ...
        if self.s["suppress_progress"] or not kwargs:
            return
    ...
    def update_now(self):
        ...
        if check:
            ...
            if self.s["backup_on_update"]:
                ...
                bckp = OSMC_Backups.osmc_backup(
                    self.s, self.progress_bar, self.parent_queue
                )
                ...
                try:
                    ...
                    log(
                        "Backup Error Type and Args: %s : %s \n\n %s"
    ...
    def settings_command_restore(self):
        ...
        try:
            ...
            if bckp.success != "Full":
                ...
                ok = DIALOG.ok(
                    "Restore", "Some items failed to restore.", "See log for details."
                )
            ...
            if restart_required:
                ...
                user_input_restart_now = DIALOG.yesno(
                    lang(32110),
                    lang(32098),
                    lang(32099),
                    yeslabel=lang(32100),
    ...
    def check_for_legit_updates(self):
        ...
        boot_space, _ = self.check_target_location_for_size(
            location="/boot", requirement=30
        )
        ...
        if not root_space or not boot_space:
            ...
            return (
                "bail",
                "Sufficient freespace: root=%s, boot=%s" % (root_space, boot_space),
            )
        ...
        if not any(
            [
                bl in av
                for bl in self.EXTERNAL_UPDATE_REQUIRED_LIST
                for av in available_updates
            ]
        ):
    ...
    def apt_update_complete(self, data=None):
        ...
        elif (self.s["on_upd_detected"] in [2, 3]) or (
            self.s["on_upd_detected"] == 4 and self.EXTERNAL_UPDATE_REQUIRED
        ):
            # Download updates, then prompt
            # Download and display icon
            # Download, install, prompt if restart needed (restart is needed)
    ...
    def automatic_freespace_checker(self):
        ...
        if self.freespace_supressor > 172800:
            ...
            freespace, value = self.check_target_location_for_size(
                location="/", requirement=250
            )
            ...
            if not freespace:
                ...
                if "Home.xml" in xbmc.getInfoLabel("Window.Property(xmlfile)"):
                    ...
                    if self.freespace_remedy == "apt":
                        ...
                        resp = DIALOG.yesno(
                            "OSMC",
                            "Your system is running out of storage (<%sMB left)."
                            % int(value),
