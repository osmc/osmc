...
pull_source "https://github.com/raspberrypi/firmware" "$(pwd)/src"
...
cp -ar src/hardfp/opt/vc/bin/ files/opt/vc
cp -ar src/hardfp/opt/vc/lib files/opt/vc
cp -ar src/hardfp/opt/vc/include files-dev/opt/vc
rm -rf src
