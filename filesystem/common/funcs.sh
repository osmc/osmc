...
SYSTEM_PKGS="base-files-osmc perftune-osmc sysctl-osmc ftr-osmc diskmount-osmc apt-utils openssh-server sudo module-init-tools connman net-tools ntp locales dialog console-setup"
