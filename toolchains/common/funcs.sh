...
XBMC_MAN_PKGS="libcecdev-osmc libshairplaydev-osmc librtmpdev-osmc git libnfsdev-osmc libafpdev-osmc"
XBMC_MAN_PKGS_RBP="rbp-libcecdev-osmc rbp-libshairplaydev-osmc rbp-librtmpdev-osmc rbp-git-osmc rbp-libnfsdev-osmc libafpdev-osmc"
